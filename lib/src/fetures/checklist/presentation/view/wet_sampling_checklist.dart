...
import 'package:actify/src/common_widgets/three_options_selector.dart';
...
class WetSamplingChecklist extends ConsumerStatefulWidget {
  const WetSamplingChecklist({super.key});

  @override
  ConsumerState<WetSamplingChecklist> createState() =>
      _WetSamplingChecklistState();
}

class _WetSamplingChecklistState extends ConsumerState<WetSamplingChecklist> {
  ...
  Widget build(BuildContext context) {
    ...
    final checklist = ref.watch(checklistsStateProvider)!.wet;
    log('WetChecklist: $checklist');
    return Padding(
          ...
          Row(
            ...
            children: [
              DateTimeFieldPlatform(
                onConfirm: (value) {
                  var val = DateFormat('yyyy-MM-dd').format(value);
              ...
              SizedBox(
                ...
                child: CustomDropDown(
                  items: const ['Lahore', 'Karachi', 'Islamabad'],
                  val: location,
                  onUpdate: (value) {
                    location = value;
                  },
